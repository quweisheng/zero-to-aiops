...
export const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: 'Traefik', route: '/tech-stack/cloud-native/traefik' },
  ...
  },
  {
    ...
    items: [
      ...
      { text: 'n8n', route: '/tech-stack/automation/n8n' },
  ...
  },
  {
    ...
    items: [
      ...
      { text: 'Apache Hive', route: '/tech-stack/data-ai/hive' },
      { text: 'Apache HBase', route: '/tech-stack/data-ai/hbase' },
      { text: 'Apache Spark', route: '/tech-stack/data-ai/spark' },
      { text: 'Apache Flink', route: '/tech-stack/data-ai/flink' },
      { text: 'Apache HAWQ（已退休）', route: '/tech-stack/data-ai/hawq' },
