...
2026 年 9 月开始全站老师带学修订：用零基础能理解的前置概念、中文注释知识地图、机制推理、两级实验和连续面试追问组织课程。技术栈以接近一万字有效正文为目标，较长文章保留完整内容；代码和输出不计入中文正文。逐篇实际篇幅与待复核项见 [老师带学修订与篇幅复核](./teaching-coverage.md)。
