...
| 3 | Alertmanager、OpenTelemetry、Loki、Elasticsearch | 已完成 | 已补齐告警治理、遥测采集、日志检索和搜索分析精讲补充 |
| 4 | Ansible、Terraform、GitHub Actions、CI/CD、Runbook Automation | 已完成 | 已补齐配置管理、基础设施即代码、流水线和 runbook 自动化精讲补充 |
| 5 | MySQL、Redis、Kafka、pandas、scikit-learn、FastAPI、LLM、RAG、向量数据库 | 已完成 | 已补齐数据处理、机器学习、API 服务、LLM、RAG 和向量检索精讲补充 |
| 6 | SLI/SLO/SLA、告警治理、事件响应、Runbook、RCA、变更管理、AIOps 闭环 | 已完成 | 已补齐可靠性目标、告警治理、事件响应、复盘、变更和闭环方法论精讲补充 |
