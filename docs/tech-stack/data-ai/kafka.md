...
| 行 | 内容 | 说明 |
|---|---|---|
| 第 1 行 | <code>Alertmanager 产生告警</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
| 第 2 行 | <code>日志解析器提取错误事件</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
| 第 3 行 | <code>CI/CD 系统产生发布事件</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
| 第 4 行 | <code>Prometheus 规则产生异常事件</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
| 第 5 行 | <code>Runbook 系统产生自动化执行记录</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
| 第 6 行 | <code>值班系统产生人工处理反馈</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
...
| 第 2 行 | <code>  "key": "order-api",</code> | 设置 `key` 字段，值是 `"order-api"`；真实环境要根据自己的告警、服务或接口返回调整。 |
| 第 3 行 | <code>  "value": {</code> | 设置 `value` 字段，值是 `{`；真实环境要根据自己的告警、服务或接口返回调整。 |
| 第 4 行 | <code>    "alert": "HighErrorRate",</code> | 设置 `alert` 字段，值是 `"HighErrorRate"`；真实环境要根据自己的告警、服务或接口返回调整。 |
...
| 第 7 行 | <code>  "timestamp": "2026-07-02T10:20:00Z",</code> | 设置 `timestamp` 字段，值是 `"2026-07-02T10:20:00Z"`；真实环境要根据自己的告警、服务或接口返回调整。 |
| 第 8 行 | <code>  "headers": {</code> | 设置 `headers` 字段，值是 `{`；真实环境要根据自己的告警、服务或接口返回调整。 |
| 第 9 行 | <code>    "source": "alertmanager"</code> | 设置 `source` 字段，值是 `"alertmanager"`；真实环境要根据自己的告警、服务或接口返回调整。 |
...
| 行 | 内容 | 说明 |
|---|---|---|
| 第 1 行 | <code>aiops-alerts</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
| 第 2 行 | <code>aiops-deployments</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
| 第 3 行 | <code>aiops-log-events</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
| 第 4 行 | <code>aiops-feedback</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
...
| 行 | 内容 | 说明 |
|---|---|---|
| 第 1 行 | <code>topic = 多个 partition log 的逻辑名字</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
...
| 第 2 行 | <code>  partition 0: offset 0, 1, 2...</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
| 第 3 行 | <code>  partition 1: offset 0, 1, 2...</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
| 第 4 行 | <code>  partition 2: offset 0, 1, 2...</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
...
| 行 | 内容 | 说明 |
|---|---|---|
| 第 1 行 | <code>partition 0</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
| 第 2 行 | <code>  offset 0</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
| 第 3 行 | <code>  offset 1</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
| 第 4 行 | <code>  offset 2</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
...
| 行 | 内容 | 说明 |
|---|---|---|
| 第 1 行 | <code>broker 0</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
| 第 2 行 | <code>broker 1</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
| 第 3 行 | <code>broker 2</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
...
| 行 | 内容 | 说明 |
|---|---|---|
| 第 1 行 | <code>一个 partition 同一时间只分配给 group 内一个 consumer</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
...
| 行 | 内容 | 说明 |
|---|---|---|
| 第 1 行 | <code>可以独立消费同一个 topic</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
...
| 第 6 行 | <code>        topic aiops-alerts</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
...
|---|---|---|
| 第 1 行 | <code>partition 0</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
| 第 2 行 | <code>  leader: broker 0</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
| 第 3 行 | <code>  replica: broker 1</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
| 第 4 行 | <code>  replica: broker 2</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
...
|---|---|---|
| 第 1 行 | <code>Topic: aiops-alerts</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
| 第 2 行 | <code>PartitionCount: ...</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
| 第 3 行 | <code>ReplicationFactor: ...</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
| 第 4 行 | <code>Partition: 0</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
| 第 5 行 | <code>Leader: ...</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
| 第 6 行 | <code>Replicas: ...</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
| 第 7 行 | <code>Isr: ...</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
...
| 行 | 内容 | 说明 |
|---|---|---|
| 第 1 行 | <code>{"service":"order-api","severity":"critical","alert":"HighErrorRate","value":0.23}</code> | JSON 列表或对象中的一行，注意逗号和引号必须符合 JSON 语法。 |
| 第 2 行 | <code>{"service":"payment-api","severity":"warning","alert":"HighLatency","value":1200}</code> | JSON 列表或对象中的一行，注意逗号和引号必须符合 JSON 语法。 |
...
| 行 | 内容 | 说明 |
|---|---|---|
| 第 1 行 | <code>Kafka 事件不会因为某个 consumer 读过就立刻消失</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
...
| 第 12 行 | <code>    "instance": "10.0.1.11",</code> | Python 代码行，通常是在调用函数、处理数据结构或把中间结果传给下一步。 |
| 第 13 行 | <code>    "severity": "critical",</code> | Python 代码行，通常是在调用函数、处理数据结构或把中间结果传给下一步。 |
| 第 14 行 | <code>    "alert": "HighErrorRate",</code> | Python 代码行，通常是在调用函数、处理数据结构或把中间结果传给下一步。 |
| 第 15 行 | <code>    "value": 0.23,</code> | Python 代码行，通常是在调用函数、处理数据结构或把中间结果传给下一步。 |
...
| 行 | 内容 | 说明 |
|---|---|---|
| 第 1 行 | <code>producer 写入速度 &gt; consumer 处理速度</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
...
| 行 | 内容 | 说明 |
|---|---|---|
| 第 1 行 | <code>projects/kafka-alert-stream/</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
...
| 第 4 行 | <code>  sample-events.jsonl</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
| 第 5 行 | <code>  producer.py</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
| 第 6 行 | <code>  consumer.py</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
...
| 行 | 内容 | 说明 |
|---|---|---|
| 第 1 行 | <code>{"event_id":"evt-001","service":"order-api","instance":"10.0.1.11","severity":"critical","alert":"HighErrorRate","value":0.23}</code> | JSON 列表或对象中的一行，注意逗号和引号必须符合 JSON 语法。 |
| 第 2 行 | <code>{"event_id":"evt-002","service":"payment-api","instance":"10.0.2.21","severity":"warning","alert":"HighLatency","value":1200}</code> | JSON 列表或对象中的一行，注意逗号和引号必须符合 JSON 语法。 |
| 第 3 行 | <code>{"event_id":"evt-003","service":"gateway","instance":"10.0.0.8","severity":"info","alert":"TrafficSpike","value":4200}</code> | JSON 列表或对象中的一行，注意逗号和引号必须符合 JSON 语法。 |
...
| 行 | 内容 | 说明 |
|---|---|---|
| 第 1 行 | <code>kafka-python</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
...
| 第 16 行 | <code>        {</code> | Python 代码行，通常是在调用函数、处理数据结构或把中间结果传给下一步。 |
| 第 17 行 | <code>            "topic": message.topic,</code> | Python 代码行，通常是在调用函数、处理数据结构或把中间结果传给下一步。 |
| 第 18 行 | <code>            "partition": message.partition,</code> | Python 代码行，通常是在调用函数、处理数据结构或把中间结果传给下一步。 |
| 第 19 行 | <code>            "offset": message.offset,</code> | Python 代码行，通常是在调用函数、处理数据结构或把中间结果传给下一步。 |
| 第 20 行 | <code>            "key": message.key.decode("utf-8") if message.key else None,</code> | Python 代码行，通常是在调用函数、处理数据结构或把中间结果传给下一步。 |
| 第 21 行 | <code>            "value": message.value,</code> | Python 代码行，通常是在调用函数、处理数据结构或把中间结果传给下一步。 |
