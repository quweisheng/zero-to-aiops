...
| 第 2 行 | <code>  -&gt; 项目总览：systemd 是什么、包含哪些系统基础组件</code> | 流程箭头，表示数据、请求或排障步骤从左边流向右边。 |
| 第 3 行 | <em>空行</em> | 空行，用来把示例结构分成更容易阅读的段落。 |
| 第 4 行 | <code>systemd(1)</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
| 第 5 行 | <code>  -&gt; systemd manager 本体</code> | 流程箭头，表示数据、请求或排障步骤从左边流向右边。 |
| 第 6 行 | <code>  -&gt; PID 1、user manager、unit、job、transaction、cgroup、unit 路径</code> | 流程箭头，表示数据、请求或排障步骤从左边流向右边。 |
| 第 7 行 | <em>空行</em> | 空行，用来把示例结构分成更容易阅读的段落。 |
| 第 8 行 | <code>systemd.unit(5)</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
| 第 9 行 | <code>  -&gt; 所有 unit 共享的语法和配置</code> | 流程箭头，表示数据、请求或排障步骤从左边流向右边。 |
| 第 10 行 | <code>  -&gt; [Unit]、[Install]</code> | 流程箭头，表示数据、请求或排障步骤从左边流向右边。 |
| 第 11 行 | <code>  -&gt; Description、Documentation、Wants、Requires、After、Before、Condition</code> | 流程箭头，表示数据、请求或排障步骤从左边流向右边。 |
| 第 12 行 | <em>空行</em> | 空行，用来把示例结构分成更容易阅读的段落。 |
| 第 13 行 | <code>systemd.service(5)</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
| 第 14 行 | <code>  -&gt; .service 专属配置</code> | 流程箭头，表示数据、请求或排障步骤从左边流向右边。 |
| 第 15 行 | <code>  -&gt; [Service]</code> | 流程箭头，表示数据、请求或排障步骤从左边流向右边。 |
| 第 16 行 | <code>  -&gt; Type、ExecStart、ExecReload、ExecStop、Restart、User、Group、WorkingDirectory</code> | 流程箭头，表示数据、请求或排障步骤从左边流向右边。 |
| 第 17 行 | <em>空行</em> | 空行，用来把示例结构分成更容易阅读的段落。 |
| 第 18 行 | <code>systemctl(1)</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
| 第 19 行 | <code>  -&gt; 管理和观察 systemd manager</code> | 流程箭头，表示数据、请求或排障步骤从左边流向右边。 |
| 第 20 行 | <code>  -&gt; status、start、stop、restart、reload、enable、disable、daemon-reload、list-units</code> | 流程箭头，表示数据、请求或排障步骤从左边流向右边。 |
| 第 21 行 | <em>空行</em> | 空行，用来把示例结构分成更容易阅读的段落。 |
| 第 22 行 | <code>journalctl(1)</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
| 第 23 行 | <code>  -&gt; 查询 systemd journal</code> | 流程箭头，表示数据、请求或排障步骤从左边流向右边。 |
| 第 24 行 | <code>  -&gt; -u、-n、-f、--since、--until、-p、-b、-o</code> | 流程箭头，表示数据、请求或排障步骤从左边流向右边。 |
| 第 25 行 | <em>空行</em> | 空行，用来把示例结构分成更容易阅读的段落。 |
| 第 26 行 | <code>systemd.timer(5)</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
| 第 27 行 | <code>  -&gt; 定时触发 unit</code> | 流程箭头，表示数据、请求或排障步骤从左边流向右边。 |
| 第 28 行 | <code>  -&gt; OnCalendar、OnBootSec、OnUnitActiveSec、Persistent</code> | 流程箭头，表示数据、请求或排障步骤从左边流向右边。 |
| 第 29 行 | <em>空行</em> | 空行，用来把示例结构分成更容易阅读的段落。 |
| 第 30 行 | <code>systemd.special(7)</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
| 第 31 行 | <code>  -&gt; 特殊 target 和 unit 名称</code> | 流程箭头，表示数据、请求或排障步骤从左边流向右边。 |
| 第 32 行 | <code>  -&gt; default.target、multi-user.target、graphical.target、rescue.target</code> | 流程箭头，表示数据、请求或排障步骤从左边流向右边。 |
| 第 33 行 | <em>空行</em> | 空行，用来把示例结构分成更容易阅读的段落。 |
| 第 34 行 | <code>systemd.exec(5)</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
| 第 35 行 | <code>  -&gt; 进程执行环境</code> | 流程箭头，表示数据、请求或排障步骤从左边流向右边。 |
| 第 36 行 | <code>  -&gt; Environment、EnvironmentFile、User、Group、WorkingDirectory、StandardOutput</code> | 流程箭头，表示数据、请求或排障步骤从左边流向右边。 |
| 第 37 行 | <em>空行</em> | 空行，用来把示例结构分成更容易阅读的段落。 |
| 第 38 行 | <code>systemd.kill(5)</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
| 第 39 行 | <code>  -&gt; 停止服务时如何发信号</code> | 流程箭头，表示数据、请求或排障步骤从左边流向右边。 |
| 第 40 行 | <code>  -&gt; KillMode、KillSignal、TimeoutStopSec</code> | 流程箭头，表示数据、请求或排障步骤从左边流向右边。 |
| 第 41 行 | <em>空行</em> | 空行，用来把示例结构分成更容易阅读的段落。 |
| 第 42 行 | <code>systemd.resource-control(5)</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
| 第 43 行 | <code>  -&gt; cgroup 资源控制</code> | 流程箭头，表示数据、请求或排障步骤从左边流向右边。 |
| 第 44 行 | <code>  -&gt; CPUWeight、MemoryMax、IOWeight</code> | 流程箭头，表示数据、请求或排障步骤从左边流向右边。 |
...
| 第 2 行 | <code>  -&gt; systemd manager 读取 unit</code> | 流程箭头，表示数据、请求或排障步骤从左边流向右边。 |
| 第 3 行 | <code>  -&gt; systemctl 发出启动/停止/查看请求</code> | 流程箭头，表示数据、请求或排障步骤从左边流向右边。 |
| 第 4 行 | <code>  -&gt; systemd 生成 job 和 transaction</code> | 流程箭头，表示数据、请求或排障步骤从左边流向右边。 |
| 第 5 行 | <code>  -&gt; systemd 按依赖和顺序执行</code> | 流程箭头，表示数据、请求或排障步骤从左边流向右边。 |
| 第 6 行 | <code>  -&gt; 服务进程放进该 unit 的 cgroup</code> | 流程箭头，表示数据、请求或排障步骤从左边流向右边。 |
| 第 7 行 | <code>  -&gt; stdout/stderr 和系统日志进入 journal</code> | 流程箭头，表示数据、请求或排障步骤从左边流向右边。 |
| 第 8 行 | <code>  -&gt; journalctl 查询证据</code> | 流程箭头，表示数据、请求或排障步骤从左边流向右边。 |
...
| 第 3 行 | <code>  -&gt; 应用进程</code> | 流程箭头，表示数据、请求或排障步骤从左边流向右边。 |
| 第 4 行 | <code>  -&gt; systemd service 管理进程生命周期</code> | 流程箭头，表示数据、请求或排障步骤从左边流向右边。 |
| 第 5 行 | <code>  -&gt; journald 收集服务日志</code> | 流程箭头，表示数据、请求或排障步骤从左边流向右边。 |
| 第 6 行 | <code>  -&gt; node exporter / process exporter 暴露机器和进程指标</code> | 流程箭头，表示数据、请求或排障步骤从左边流向右边。 |
| 第 7 行 | <code>  -&gt; Prometheus 抓指标</code> | 流程箭头，表示数据、请求或排障步骤从左边流向右边。 |
| 第 8 行 | <code>  -&gt; Alertmanager 发告警</code> | 流程箭头，表示数据、请求或排障步骤从左边流向右边。 |
| 第 9 行 | <code>  -&gt; Runbook / 自动化脚本调用 systemctl 诊断或恢复</code> | 流程箭头，表示数据、请求或排障步骤从左边流向右边。 |
...
| 第 2 行 | <code>  -&gt; /sbin/init</code> | 流程箭头，表示数据、请求或排障步骤从左边流向右边。 |
| 第 3 行 | <code>  -&gt; systemd (PID 1)</code> | 流程箭头，表示数据、请求或排障步骤从左边流向右边。 |
| 第 4 行 | <code>  -&gt; 读取 unit</code> | 流程箭头，表示数据、请求或排障步骤从左边流向右边。 |
| 第 5 行 | <code>  -&gt; 计算依赖</code> | 流程箭头，表示数据、请求或排障步骤从左边流向右边。 |
| 第 6 行 | <code>  -&gt; 启动基础系统</code> | 流程箭头，表示数据、请求或排障步骤从左边流向右边。 |
| 第 7 行 | <code>  -&gt; 启动服务</code> | 流程箭头，表示数据、请求或排障步骤从左边流向右边。 |
| 第 8 行 | <code>  -&gt; 监督服务进程</code> | 流程箭头，表示数据、请求或排障步骤从左边流向右边。 |
| 第 9 行 | <code>  -&gt; 处理失败、重启、停止、日志</code> | 流程箭头，表示数据、请求或排障步骤从左边流向右边。 |
...
| 第 2 行 | <code>  -&gt; systemctl 把请求发给 systemd manager</code> | 流程箭头，表示数据、请求或排障步骤从左边流向右边。 |
| 第 3 行 | <code>  -&gt; systemd 计算 job 和依赖</code> | 流程箭头，表示数据、请求或排障步骤从左边流向右边。 |
| 第 4 行 | <code>  -&gt; systemd 停止旧进程并启动新进程</code> | 流程箭头，表示数据、请求或排障步骤从左边流向右边。 |
| 第 5 行 | <code>  -&gt; systemctl 显示结果</code> | 流程箭头，表示数据、请求或排障步骤从左边流向右边。 |
...
| 第 2 行 | <code>  -&gt; 触发</code> | 流程箭头，表示数据、请求或排障步骤从左边流向右边。 |
