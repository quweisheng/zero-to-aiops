...
| 行 | 内容 | 说明 |
|---|---|---|
| 第 1 行 | <code>Getting Started</code> | 这一行里的英文要这样读：`Getting Started` 是英文标识，通常代表字段名、组件名、文件名、资源名或示例值。 |
| 第 2 行 | <code>  -&gt; Git 是什么，如何安装和配置</code> | 这一行要理解这些英文词：`Git` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
| 第 3 行 | <code>Git Basics</code> | 这一行里的英文要这样读：`Git Basics` 是英文标识，通常代表字段名、组件名、文件名、资源名或示例值。 |
| 第 4 行 | <code>  -&gt; 仓库、文件状态、暂存、提交、历史、撤销、远程</code> | 这一行表示上一级主题下的子项“仓库、文件状态、暂存、提交、历史、撤销、远程”。`->` 只是知识地图里的层级符号，真正要理解的是这句话里的操作或概念。 |
| 第 5 行 | <code>Git Branching</code> | 这一行里的英文要这样读：`Git Branching` 是英文标识，通常代表字段名、组件名、文件名、资源名或示例值。 |
| 第 6 行 | <code>  -&gt; 分支、合并、冲突、分支工作流</code> | 这一行表示上一级主题下的子项“分支、合并、冲突、分支工作流”。`->` 只是知识地图里的层级符号，真正要理解的是这句话里的操作或概念。 |
| 第 7 行 | <code>Git on the Server / GitHub</code> | `Git on the Server / GitHub` 是文件、目录、接口路径或匹配模式示例，用来告诉读者真实项目里应该把学习证据、配置或代码放在哪里。 |
| 第 8 行 | <code>  -&gt; 远程协作和托管</code> | 这一行表示上一级主题下的子项“远程协作和托管”。`->` 只是知识地图里的层级符号，真正要理解的是这句话里的操作或概念。 |
| 第 9 行 | <code>Git Tools</code> | 这一行里的英文要这样读：`Git Tools` 是英文标识，通常代表字段名、组件名、文件名、资源名或示例值。 |
| 第 10 行 | <code>  -&gt; stash、tag、rebase、reset、高级查看</code> | 这一行要理解这些英文词：`stash` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题；`tag` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题；`rebase` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题；`reset` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
| 第 11 行 | <code>Git Internals</code> | 这一行里的英文要这样读：`Git Internals` 是英文标识，通常代表字段名、组件名、文件名、资源名或示例值。 |
| 第 12 行 | <code>  -&gt; 对象、引用、packfile、refspec</code> | 这一行要理解这些英文词：`packfile` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题；`refspec` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
| 第 13 行 | <code>Reference</code> | 这一行里的英文要这样读：`Reference` 是名称、状态或组件标识，真实环境里要结合上下文确认它指的是哪个告警、服务或资源。 |
| 第 14 行 | <code>  -&gt; 每个命令的完整参数</code> | 这一行表示上一级主题下的子项“每个命令的完整参数”。`->` 只是知识地图里的层级符号，真正要理解的是这句话里的操作或概念。 |
...
| 行 | 内容 | 说明 |
|---|---|---|
| 第 2 行 | <code>  -&gt; 给这次状态一个说明</code> | 这一行表示上一级主题下的子项“给这次状态一个说明”。`->` 只是知识地图里的层级符号，真正要理解的是这句话里的操作或概念。 |
| 第 3 行 | <code>  -&gt; 以后可以比较、回退、分支、合并、同步</code> | 这一行表示上一级主题下的子项“以后可以比较、回退、分支、合并、同步”。`->` 只是知识地图里的层级符号，真正要理解的是这句话里的操作或概念。 |
...
| 行 | 内容 | 说明 |
|---|---|---|
| 第 1 行 | <code>Git 负责记录变化。</code> | 这一行里的英文要这样读：`Git` 是名称、状态或组件标识，真实环境里要结合上下文确认它指的是哪个告警、服务或资源。 |
| 第 2 行 | <code>GitHub 负责把仓库放到网上协作和展示。</code> | 这一行里的英文要这样读：`GitHub` 是名称、状态或组件标识，真实环境里要结合上下文确认它指的是哪个告警、服务或资源。 |
...
| 行 | 内容 | 说明 |
|---|---|---|
| 第 2 行 | <code>  + .git 目录</code> | `+ .git 目录` 是文件、目录、接口路径或匹配模式示例，用来告诉读者真实项目里应该把学习证据、配置或代码放在哪里。 |
...
| 行 | 内容 | 说明 |
|---|---|---|
| 第 1 行 | <code>Working Tree</code> | 这一行里的英文要这样读：`Working Tree` 是英文标识，通常代表字段名、组件名、文件名、资源名或示例值。 |
| 第 2 行 | <code>  -&gt; 你当前看得见、正在编辑的文件</code> | 这一行表示上一级主题下的子项“你当前看得见、正在编辑的文件”。`->` 只是知识地图里的层级符号，真正要理解的是这句话里的操作或概念。 |
| 第 4 行 | <code>Index / Staging Area</code> | `Index / Staging Area` 是文件、目录、接口路径或匹配模式示例，用来告诉读者真实项目里应该把学习证据、配置或代码放在哪里。 |
| 第 5 行 | <code>  -&gt; 准备放进下一次 commit 的内容</code> | 这一行要理解这些英文词：`commit` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
| 第 7 行 | <code>HEAD / Local Repository</code> | `HEAD / Local Repository` 是文件、目录、接口路径或匹配模式示例，用来告诉读者真实项目里应该把学习证据、配置或代码放在哪里。 |
| 第 8 行 | <code>  -&gt; 当前分支最近一次 commit</code> | 这一行要理解这些英文词：`commit` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
...
| 行 | 内容 | 说明 |
|---|---|---|
| 第 1 行 | <code>修改了 Linux 文档</code> | 这一行里的英文要这样读：`Linux` 是名称、状态或组件标识，真实环境里要结合上下文确认它指的是哪个告警、服务或资源。 |
| 第 2 行 | <code>修改了 README</code> | 这一行里的英文要这样读：`README` 是名称、状态或组件标识，真实环境里要结合上下文确认它指的是哪个告警、服务或资源。 |
| 第 3 行 | <code>修改了 package.json</code> | `修改了 package.json` 是文件、目录、接口路径或匹配模式示例，用来告诉读者真实项目里应该把学习证据、配置或代码放在哪里。 |
| 第 5 行 | <code>这三件事不一定属于同一个 commit。</code> | 这一行里的英文要这样读：`commit` 是英文标识，通常代表字段名、组件名、文件名、资源名或示例值。 |
...
| 行 | 内容 | 说明 |
|---|---|---|
| 第 1 行 | <code>?? new.md</code> | `?? new.md` 是文件、目录、接口路径或匹配模式示例，用来告诉读者真实项目里应该把学习证据、配置或代码放在哪里。 |
| 第 2 行 | <code> M linux.md</code> | `M linux.md` 是文件、目录、接口路径或匹配模式示例，用来告诉读者真实项目里应该把学习证据、配置或代码放在哪里。 |
| 第 3 行 | <code>M  git.md</code> | `M  git.md` 是文件、目录、接口路径或匹配模式示例，用来告诉读者真实项目里应该把学习证据、配置或代码放在哪里。 |
| 第 4 行 | <code>A  prometheus.md</code> | `A  prometheus.md` 是文件、目录、接口路径或匹配模式示例，用来告诉读者真实项目里应该把学习证据、配置或代码放在哪里。 |
...
| 第 2 行 | <code>  -&gt; tree</code> | 这一行要理解这些英文词：`tree` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
| 第 3 行 | <code>       -&gt; README.md blob</code> | 这一行要理解这些英文词：`README.md blob` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
| 第 4 行 | <code>       -&gt; docs/ tree</code> | 这一行要理解这些英文词：`docs` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题；`tree` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
| 第 5 行 | <code>            -&gt; linux.md blob</code> | 这一行要理解这些英文词：`linux.md blob` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
| 第 6 行 | <code>  -&gt; parent commit</code> | 这一行要理解这些英文词：`parent commit` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
| 第 7 行 | <code>  -&gt; author</code> | 这一行要理解这些英文词：`author` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
| 第 8 行 | <code>  -&gt; message</code> | 这一行要理解这些英文词：`message` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
...
| 行 | 内容 | 说明 |
|---|---|---|
| 第 1 行 | <code>HEAD -&gt; refs/heads/main -&gt; 某个 commit</code> | 这一行要理解这些英文词：`HEAD` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题；`refs` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题；`heads` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题；`main` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题；`commit` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
...
| 行 | 内容 | 说明 |
|---|---|---|
| 第 1 行 | <code>update</code> | 这一行里的英文要这样读：`update` 是英文标识，通常代表字段名、组件名、文件名、资源名或示例值。 |
| 第 2 行 | <code>fix</code> | 这一行里的英文要这样读：`fix` 是英文标识，通常代表字段名、组件名、文件名、资源名或示例值。 |
...
| 行 | 内容 | 说明 |
|---|---|---|
| 第 1 行 | <code>docs: deepen linux tutorial</code> | `docs` 是docs 是英文标识，通常代表字段名、组件名、文件名、资源名或示例值，冒号后面的 `deepen linux tutorial` 是这个字段的示例内容或模板表达式。 |
| 第 2 行 | <code>docs: add prometheus alert rule example</code> | `docs` 是docs 是英文标识，通常代表字段名、组件名、文件名、资源名或示例值，冒号后面的 `add prometheus alert rule example` 是这个字段的示例内容或模板表达式。 |
| 第 3 行 | <code>fix: correct grafana datasource URL</code> | `fix` 是fix 是英文标识，通常代表字段名、组件名、文件名、资源名或示例值，冒号后面的 `correct grafana datasource URL` 是这个字段的示例内容或模板表达式。 |
| 第 4 行 | <code>chore: update vitepress config</code> | `chore` 是chore 是英文标识，通常代表字段名、组件名、文件名、资源名或示例值，冒号后面的 `update vitepress config` 是这个字段的示例内容或模板表达式。 |
...
| 行 | 内容 | 说明 |
|---|---|---|
| 第 1 行 | <code>main -&gt; C3</code> | 这一行要理解这些英文词：`main` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题；`C3` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
| 第 3 行 | <code>C1 -&gt; C2 -&gt; C3</code> | 这一行要理解这些英文词：`C1` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题；`C2` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题；`C3` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
...
|---|---|---|
| 第 1 行 | <code>main              -&gt; C3</code> | 这一行要理解这些英文词：`main` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题；`C3` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
| 第 2 行 | <code>docs/git-deep-dive -&gt; C3</code> | 这一行要理解这些英文词：`docs` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题；`git-deep-dive` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题；`C3` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
| 第 3 行 | <code>HEAD -&gt; docs/git-deep-dive</code> | 这一行要理解这些英文词：`HEAD` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题；`docs` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题；`git-deep-dive` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
...
|---|---|---|
| 第 1 行 | <code>main              -&gt; C3</code> | 这一行要理解这些英文词：`main` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题；`C3` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
| 第 2 行 | <code>docs/git-deep-dive -&gt; C4</code> | 这一行要理解这些英文词：`docs` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题；`git-deep-dive` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题；`C4` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
...
|---|---|---|
| 第 1 行 | <code>main -&gt; C3</code> | 这一行要理解这些英文词：`main` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题；`C3` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
| 第 2 行 | <code>feature -&gt; C4</code> | 这一行要理解这些英文词：`feature` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题；`C4` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
| 第 4 行 | <code>merge 后：</code> | 这一行里的英文要这样读：`merge` 是英文标识，通常代表字段名、组件名、文件名、资源名或示例值。 |
| 第 5 行 | <code>main -&gt; C4</code> | 这一行要理解这些英文词：`main` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题；`C4` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
...
| 行 | 内容 | 说明 |
|---|---|---|
| 第 1 行 | <code>      C4 feature</code> | 这一行里的英文要这样读：`C4 feature` 是英文标识，通常代表字段名、组件名、文件名、资源名或示例值。 |
| 第 2 行 | <code>     /</code> | `/` 是目录示例，用来告诉读者真实项目里应该把学习证据、配置或代码放在哪里。 |
| 第 3 行 | <code>C1-C2-C3 main</code> | 这一行里的英文要这样读：`C1-C2-C3 main` 是英文标识，通常代表字段名、组件名、文件名、资源名或示例值。 |
| 第 4 行 | <code>     \</code> | `\` 是文件、目录、接口路径或匹配模式示例，用来告诉读者真实项目里应该把学习证据、配置或代码放在哪里。 |
| 第 5 行 | <code>      C5 main</code> | 这一行里的英文要这样读：`C5 main` 是英文标识，通常代表字段名、组件名、文件名、资源名或示例值。 |
...
| 行 | 内容 | 说明 |
|---|---|---|
| 第 1 行 | <code>&lt; &lt; &lt; &lt; &lt; &lt; &lt; HEAD</code> | 这一行里的英文要这样读：`HEAD` 是名称、状态或组件标识，真实环境里要结合上下文确认它指的是哪个告警、服务或资源。 |
| 第 3 行 | <code>= = = = = = =</code> | 这一行是符号、路径或状态片段，需要结合上下文确认它连接的是哪个组件、文件或排障证据。 |
| 第 5 行 | <code>&gt; &gt; &gt; &gt; &gt; &gt; &gt; feature</code> | 这一行里的英文要这样读：`feature` 是英文标识，通常代表字段名、组件名、文件名、资源名或示例值。 |
...
| 行 | 内容 | 说明 |
|---|---|---|
| 第 1 行 | <code>git fetch</code> | 这一行里的英文要这样读：`git fetch` 是英文标识，通常代表字段名、组件名、文件名、资源名或示例值。 |
| 第 2 行 | <code>  + git merge 或 git rebase</code> | 这一行里的英文要这样读：`git merge` 是英文标识，通常代表字段名、组件名、文件名、资源名或示例值；`git rebase` 是英文标识，通常代表字段名、组件名、文件名、资源名或示例值。 |
...
| 行 | 内容 | 说明 |
|---|---|---|
| 第 1 行 | <code>node_modules/</code> | `node_modules/` 是目录示例，用来告诉读者真实项目里应该把学习证据、配置或代码放在哪里。 |
| 第 2 行 | <code>.vitepress/cache/</code> | `.vitepress/cache/` 是目录示例，用来告诉读者真实项目里应该把学习证据、配置或代码放在哪里。 |
| 第 3 行 | <code>.vitepress/dist/</code> | `.vitepress/dist/` 是目录示例，用来告诉读者真实项目里应该把学习证据、配置或代码放在哪里。 |
| 第 4 行 | <code>.env</code> | `.env` 是文件、目录、接口路径或匹配模式示例，用来告诉读者真实项目里应该把学习证据、配置或代码放在哪里。 |
| 第 5 行 | <code>*.log</code> | `*.log` 是文件、目录、接口路径或匹配模式示例，用来告诉读者真实项目里应该把学习证据、配置或代码放在哪里。 |
| 第 6 行 | <code>__pycache__/</code> | `__pycache__/` 是目录示例，用来告诉读者真实项目里应该把学习证据、配置或代码放在哪里。 |
| 第 7 行 | <code>.venv/</code> | `.venv/` 是目录示例，用来告诉读者真实项目里应该把学习证据、配置或代码放在哪里。 |
...
| 行 | 内容 | 说明 |
|---|---|---|
| 第 1 行 | <code>v0.1-linux-deep-dive</code> | `v0.1-linux-deep-dive` 是文件、目录、接口路径或匹配模式示例，用来告诉读者真实项目里应该把学习证据、配置或代码放在哪里。 |
| 第 2 行 | <code>v0.2-observability-lab</code> | `v0.2-observability-lab` 是文件、目录、接口路径或匹配模式示例，用来告诉读者真实项目里应该把学习证据、配置或代码放在哪里。 |
...
| 行 | 内容 | 说明 |
|---|---|---|
| 第 2 行 | <code>  -&gt; 修改一小组相关文件</code> | 这一行表示上一级主题下的子项“修改一小组相关文件”。`->` 只是知识地图里的层级符号，真正要理解的是这句话里的操作或概念。 |
| 第 3 行 | <code>  -&gt; git status</code> | 这一行要理解这些英文词：`git status` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
| 第 4 行 | <code>  -&gt; git diff</code> | 这一行要理解这些英文词：`git diff` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
| 第 5 行 | <code>  -&gt; git add 相关文件</code> | 这一行要理解这些英文词：`git add` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
| 第 6 行 | <code>  -&gt; git diff --staged</code> | 这一行要理解这些英文词：`git diff` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题；`staged` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
| 第 7 行 | <code>  -&gt; git commit -m "docs: ..."</code> | 这一行要理解这些英文词：`git commit` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题；`m` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题；`docs` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
| 第 8 行 | <code>  -&gt; git push</code> | 这一行要理解这些英文词：`git push` 是英文术语，表示本节知识地图里的一个组件、命令、状态或学习主题。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
...
| 行 | 内容 | 说明 |
|---|---|---|
| 第 2 行 | <code>哪些文件还没被 Git 跟踪？</code> | 这一行里的英文要这样读：`Git` 是名称、状态或组件标识，真实环境里要结合上下文确认它指的是哪个告警、服务或资源。 |
...
| 行 | 内容 | 说明 |
|---|---|---|
| 第 1 行 | <code># Git 第一周练习</code> | 这一行里的英文要这样读：`Git` 是名称、状态或组件标识，真实环境里要结合上下文确认它指的是哪个告警、服务或资源。 |
| 第 3 行 | <code>## 我理解的 Git</code> | 这一行里的英文要这样读：`Git` 是名称、状态或组件标识，真实环境里要结合上下文确认它指的是哪个告警、服务或资源。 |
| 第 5 行 | <code>Git 是记录项目变化的工具。它用 commit 保存快照，用 branch 支持并行修改，用 remote 同步到 GitHub。</code> | Markdown 正文示例，展示文档里应该怎样写说明内容。 |
| 第 9 行 | <code>- git status</code> | 这一行里的英文要这样读：`git status` 这个英文标识可以拆开理解为：状态字段。 |
| 第 10 行 | <code>- git diff</code> | 这一行里的英文要这样读：`git diff` 是英文标识，通常代表字段名、组件名、文件名、资源名或示例值。 |
| 第 11 行 | <code>- git add</code> | 这一行里的英文要这样读：`git add` 是英文标识，通常代表字段名、组件名、文件名、资源名或示例值。 |
| 第 12 行 | <code>- git commit</code> | 这一行里的英文要这样读：`git commit` 是英文标识，通常代表字段名、组件名、文件名、资源名或示例值。 |
| 第 13 行 | <code>- git log</code> | 这一行里的英文要这样读：`git log` 是英文标识，通常代表字段名、组件名、文件名、资源名或示例值。 |
| 第 14 行 | <code>- git push</code> | 这一行里的英文要这样读：`git push` 是英文标识，通常代表字段名、组件名、文件名、资源名或示例值。 |
| 第 18 行 | <code>- reset 和 revert 的区别</code> | 这一行里的英文要这样读：`reset` 是英文标识，通常代表字段名、组件名、文件名、资源名或示例值；`revert` 是英文标识，通常代表字段名、组件名、文件名、资源名或示例值。 |
| 第 19 行 | <code>- merge 冲突怎么处理</code> | 这一行里的英文要这样读：`merge` 是英文标识，通常代表字段名、组件名、文件名、资源名或示例值。 |
| 第 20 行 | <code>- rebase 什么时候用</code> | 这一行里的英文要这样读：`rebase` 是英文标识，通常代表字段名、组件名、文件名、资源名或示例值。 |
