...
| 第 2 行 | <code>  -&gt; Git 是什么，如何安装和配置</code> | 这一行要理解这些英文词：`Git` 是版本控制工具。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
...
| 第 10 行 | <code>  -&gt; stash、tag、rebase、reset、高级查看</code> | 这一行要理解这些英文词：`stash` 是英文关键字，表示本节知识地图里的一个组件、命令、状态或学习主题；`tag` 是标签，Git 中常用来标记版本；`rebase` 是英文关键字，表示本节知识地图里的一个组件、命令、状态或学习主题；`reset` 是英文关键字，表示本节知识地图里的一个组件、命令、状态或学习主题。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
| 第 11 行 | <code>Git Internals</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
| 第 12 行 | <code>  -&gt; 对象、引用、packfile、refspec</code> | 这一行要理解这些英文词：`packfile` 是英文关键字，表示本节知识地图里的一个组件、命令、状态或学习主题；`refspec` 是英文关键字，表示本节知识地图里的一个组件、命令、状态或学习主题。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
...
| 第 5 行 | <code>  -&gt; 准备放进下一次 commit 的内容</code> | 这一行要理解这些英文词：`commit` 是Git 提交，保存一次代码或文档变更快照。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
| 第 6 行 | <em>空行</em> | 空行，用来把示例结构分成更容易阅读的段落。 |
| 第 7 行 | <code>HEAD / Local Repository</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
| 第 8 行 | <code>  -&gt; 当前分支最近一次 commit</code> | 这一行要理解这些英文词：`commit` 是Git 提交，保存一次代码或文档变更快照。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
...
| 第 2 行 | <code>  -&gt; tree</code> | 这一行要理解这些英文词：`tree` 是英文关键字，表示本节知识地图里的一个组件、命令、状态或学习主题。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
| 第 3 行 | <code>       -&gt; README.md blob</code> | 这一行要理解这些英文词：`README.md blob` 是英文关键字，表示本节知识地图里的一个组件、命令、状态或学习主题。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
| 第 4 行 | <code>       -&gt; docs/ tree</code> | 这一行要理解这些英文词：`docs` 是文档目录或文档集合；`tree` 是英文关键字，表示本节知识地图里的一个组件、命令、状态或学习主题。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
| 第 5 行 | <code>            -&gt; linux.md blob</code> | 这一行要理解这些英文词：`linux.md blob` 是英文关键字，表示本节知识地图里的一个组件、命令、状态或学习主题。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
| 第 6 行 | <code>  -&gt; parent commit</code> | 这一行要理解这些英文词：`parent commit` 是英文关键字，表示本节知识地图里的一个组件、命令、状态或学习主题。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
| 第 7 行 | <code>  -&gt; author</code> | 这一行要理解这些英文词：`author` 是英文关键字，表示本节知识地图里的一个组件、命令、状态或学习主题。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
| 第 8 行 | <code>  -&gt; message</code> | 这一行要理解这些英文词：`message` 是英文关键字，表示本节知识地图里的一个组件、命令、状态或学习主题。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
...
| 行 | 内容 | 说明 |
|---|---|---|
| 第 1 行 | <code>HEAD -&gt; refs/heads/main -&gt; 某个 commit</code> | 这一行要理解这些英文词：`HEAD` 是英文缩写或固定标识，结合本节上下文记住它代表的组件、命令或状态；`refs` 是英文关键字，表示本节知识地图里的一个组件、命令、状态或学习主题；`heads` 是英文关键字，表示本节知识地图里的一个组件、命令、状态或学习主题；`main` 是主分支或主入口，具体含义取决于 Git 或程序上下文；`commit` 是Git 提交，保存一次代码或文档变更快照。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
...
| 行 | 内容 | 说明 |
|---|---|---|
| 第 1 行 | <code>main -&gt; C3</code> | 这一行要理解这些英文词：`main` 是主分支或主入口，具体含义取决于 Git 或程序上下文；`C3` 是英文缩写或固定标识，结合本节上下文记住它代表的组件、命令或状态。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
| 第 2 行 | <em>空行</em> | 空行，用来把示例结构分成更容易阅读的段落。 |
| 第 3 行 | <code>C1 -&gt; C2 -&gt; C3</code> | 这一行要理解这些英文词：`C1` 是英文缩写或固定标识，结合本节上下文记住它代表的组件、命令或状态；`C2` 是英文缩写或固定标识，结合本节上下文记住它代表的组件、命令或状态；`C3` 是英文缩写或固定标识，结合本节上下文记住它代表的组件、命令或状态。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
...
|---|---|---|
| 第 1 行 | <code>main              -&gt; C3</code> | 这一行要理解这些英文词：`main` 是主分支或主入口，具体含义取决于 Git 或程序上下文；`C3` 是英文缩写或固定标识，结合本节上下文记住它代表的组件、命令或状态。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
| 第 2 行 | <code>docs/git-deep-dive -&gt; C3</code> | 这一行要理解这些英文词：`docs` 是文档目录或文档集合；`git-deep-dive` 是git=版本控制工具；`C3` 是英文缩写或固定标识，结合本节上下文记住它代表的组件、命令或状态。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
| 第 3 行 | <code>HEAD -&gt; docs/git-deep-dive</code> | 这一行要理解这些英文词：`HEAD` 是英文缩写或固定标识，结合本节上下文记住它代表的组件、命令或状态；`docs` 是文档目录或文档集合；`git-deep-dive` 是git=版本控制工具。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
...
|---|---|---|
| 第 1 行 | <code>main              -&gt; C3</code> | 这一行要理解这些英文词：`main` 是主分支或主入口，具体含义取决于 Git 或程序上下文；`C3` 是英文缩写或固定标识，结合本节上下文记住它代表的组件、命令或状态。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
| 第 2 行 | <code>docs/git-deep-dive -&gt; C4</code> | 这一行要理解这些英文词：`docs` 是文档目录或文档集合；`git-deep-dive` 是git=版本控制工具；`C4` 是英文缩写或固定标识，结合本节上下文记住它代表的组件、命令或状态。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
...
|---|---|---|
| 第 1 行 | <code>main -&gt; C3</code> | 这一行要理解这些英文词：`main` 是主分支或主入口，具体含义取决于 Git 或程序上下文；`C3` 是英文缩写或固定标识，结合本节上下文记住它代表的组件、命令或状态。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
| 第 2 行 | <code>feature -&gt; C4</code> | 这一行要理解这些英文词：`feature` 是功能或特性；`C4` 是英文缩写或固定标识，结合本节上下文记住它代表的组件、命令或状态。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
| 第 3 行 | <em>空行</em> | 空行，用来把示例结构分成更容易阅读的段落。 |
| 第 4 行 | <code>merge 后：</code> | 文本示例行，用来展示输出、目录、流程、错误信息或学习证据中的一条内容。 |
| 第 5 行 | <code>main -&gt; C4</code> | 这一行要理解这些英文词：`main` 是主分支或主入口，具体含义取决于 Git 或程序上下文；`C4` 是英文缩写或固定标识，结合本节上下文记住它代表的组件、命令或状态。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
...
| 第 3 行 | <code>  -&gt; git status</code> | 这一行要理解这些英文词：`git status` 是git=版本控制工具。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
| 第 4 行 | <code>  -&gt; git diff</code> | 这一行要理解这些英文词：`git diff` 是git=版本控制工具，diff=差异。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
| 第 5 行 | <code>  -&gt; git add 相关文件</code> | 这一行要理解这些英文词：`git add` 是git=版本控制工具。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
| 第 6 行 | <code>  -&gt; git diff --staged</code> | 这一行要理解这些英文词：`git diff` 是git=版本控制工具，diff=差异；`staged` 是英文关键字，表示本节知识地图里的一个组件、命令、状态或学习主题。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
| 第 7 行 | <code>  -&gt; git commit -m "docs: ..."</code> | 这一行要理解这些英文词：`git commit` 是git=版本控制工具；`m` 是英文关键字，表示本节知识地图里的一个组件、命令、状态或学习主题；`docs` 是文档目录或文档集合。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
| 第 8 行 | <code>  -&gt; git push</code> | 这一行要理解这些英文词：`git push` 是git=版本控制工具。`->` 只是知识地图里的层级符号，不是要学习的概念。 |
