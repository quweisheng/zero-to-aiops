...
全站采用老师带学生的学习方式：先解释前置概念，再沿业务场景追机制，完成基础和故障实验，最后练习设计取舍与面试追问。官方英文知识地图和其他教学图保留英文名称并加中文释义。文章以接近一万字有效正文为目标，实际情况见 [逐篇修订与篇幅复核](./tech-stack/teaching-coverage.md)；学习从 [零基础路线](./roadmap/README.md) 开始。
