...
全站采用老师带学生的学习方式：先解释前置概念，再沿业务场景追机制，完成基础和故障实验，最后练习设计取舍与面试追问。官方英文知识地图和其他教学图保留英文名称并加中文释义。114 篇技术栈已完成本轮修订，每篇中文正文均不少于一万字，代码和输出不充当正文；实际统计见 [逐篇修订与篇幅复核](./tech-stack/teaching-coverage.md)。学习从 [零基础路线](./roadmap/README.md) 开始，不必同时学完所有技术栈。
...
后续新增与维护继续遵守 [技术栈精讲写作标准](./tech-stack/writing-standard.md)。文章完成不代表读者已经掌握，也不表示全部真实平台实验已代为执行；请按自己的隔离环境保存实际结果，把独立练习与复盘沉淀到 GitHub。
...
前端主线已补到 Kubernetes 同级的机制与生产深度，包括 HTML/CSS 浏览器管线、JavaScript 运行时、HTTP 一致性、TypeScript 类型系统、Vue/React 调度、水合、容量、安全、升级、故障实验和系统设计。

私有云新增 [FusionSphere / FusionCompute](./tech-stack/virtualization-private-cloud/fusionsphere.md) 和 [腾讯 TCE 全栈地图](./tech-stack/virtualization-private-cloud/tencent-tce.md)。TCE 采用“平台必修 + 现场 BOM 选修”的边界：公开产品文档帮助理解语义，但只有版本、BOM、License、控制台和合同证据能证明现场实际能力。
...
- [TKE on TCE](./tech-stack/cloud-native/tke-on-tce.md)
...
- [华为 FusionSphere / FusionCompute](./tech-stack/virtualization-private-cloud/fusionsphere.md)
- [腾讯专有云 TCE 全栈地图](./tech-stack/virtualization-private-cloud/tencent-tce.md)
- [TCE IaaS](./tech-stack/virtualization-private-cloud/tce-iaas.md)
- [TCE 运营、运维与安全](./tech-stack/virtualization-private-cloud/tce-operations-security.md)
...
- [TCE 存储与数据保护](./tech-stack/storage-data-protection/tce-storage.md)
...
- [SonarQube](./tech-stack/automation/sonarqube.md)

### 架构与方案设计

- [系统架构与技术方案设计](./tech-stack/architecture-delivery/architecture-solution-design.md)
- [IT 项目管理 / PMP](./tech-stack/architecture-delivery/it-project-management-pmp.md)
...
- [TDSQL-C MySQL](./tech-stack/data-ai/tdsql-mysql.md)
- [Oracle Database](./tech-stack/data-ai/oracle.md)
- [PostgreSQL](./tech-stack/data-ai/postgresql.md)
- [MongoDB](./tech-stack/data-ai/mongodb.md)
- [Redis](./tech-stack/data-ai/redis.md)
- [Kafka](./tech-stack/data-ai/kafka.md)
- [Apache Pulsar](./tech-stack/data-ai/apache-pulsar.md)
- [TCE 数据库、缓存、消息与数据平台地图](./tech-stack/data-ai/tce-data-middleware.md)
- [Apache ActiveMQ](./tech-stack/data-ai/activemq.md)
...
- [Apache Hive](./tech-stack/data-ai/hive.md)
- [Apache HBase](./tech-stack/data-ai/hbase.md)
- [Apache Spark](./tech-stack/data-ai/spark.md)
- [Apache Flink](./tech-stack/data-ai/flink.md)
- [Apache HAWQ（已退休）](./tech-stack/data-ai/hawq.md)
...
- [PyTorch](./tech-stack/data-ai/pytorch.md)
...
18. [SonarQube](./tech-stack/automation/sonarqube.md)
19. [Apache Maven](./tech-stack/automation/maven.md)
20. [MongoDB](./tech-stack/data-ai/mongodb.md)
21. [Apache ActiveMQ](./tech-stack/data-ai/activemq.md)
22. [网络安全等级保护（等保 2.0）](./tech-stack/security-compliance/mlps.md)
23. [JumpServer](./tech-stack/security-compliance/jumpserver.md)
24. [Kubernetes 平台运维岗位专项路线](./interview/kubernetes-platform-operations-role.md)
25. [河北鹰眼智能运维工程师岗位专项面试路线](./interview/hebei-eagle-eye-operations-engineer-role.md)
26. [Apache Hive](./tech-stack/data-ai/hive.md)
27. [Apache HBase](./tech-stack/data-ai/hbase.md)
...
31. [PyTorch](./tech-stack/data-ai/pytorch.md)
32. [Transformer](./tech-stack/data-ai/transformer.md)
33. [Dify](./tech-stack/data-ai/dify.md)
34. [n8n](./tech-stack/automation/n8n.md)
35. [Ollama](./tech-stack/data-ai/ollama.md)
